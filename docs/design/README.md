...
| DESIGN-0003 | Support docz-api's no-auth mode and the session-unavailable 503 | Draft | 2026-08-27 | Donald Gifford | [0003-support-docz-apis-no-auth-mode-and-the-session-unavailable-503.md](0003-support-docz-apis-no-auth-mode-and-the-session-unavailable-503.md) |
