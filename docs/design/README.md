...
| DESIGN-0006 | Server observability — structured logging, split probes, Prometheus metrics, and OTel tracing | Draft | 2026-09-18 | Donald Gifford | [0006-server-observability-structured-logging-split-probes-prometheus.md](0006-server-observability-structured-logging-split-probes-prometheus.md) |
