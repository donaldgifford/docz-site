...
| IMPL-0004 | No-auth mode and session-unavailable handling | Draft | 2026-08-27 | Donald Gifford | [0004-no-auth-mode-and-session-unavailable-handling.md](0004-no-auth-mode-and-session-unavailable-handling.md) |
